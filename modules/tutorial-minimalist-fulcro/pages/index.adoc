...
Instead of JSX, we use functions from the https://github.com/fulcrologic/fulcro/blob/main/src/main/com/fulcrologic/fulcro/dom.cljs[`dom` namespace] for rendering HTML tags and React factories for rendering React components.
